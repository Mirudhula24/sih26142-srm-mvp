...
export const LAND_COVER_CLASSES = [
  { id: 0, key: 'built_up',   label: 'Urban',      color: '#ef4444' },
...
export const CACHED_REGIONS = [
  ...
  { key: 'chennai_coastal', label: 'Chennai — coastal metro', center: [80.24, 13.05], zoom: 12, bbox: [80.10, 12.85, 80.35, 13.25] },
  { key: 'hyderabad_urban', label: 'Hyderabad — urban plateau', center: [78.48, 17.39], zoom: 12, bbox: [78.30, 17.25, 78.65, 17.55] },
  { key: 'bangalore_urban', label: 'Bangalore — urban tech corridor', center: [77.59, 12.97], zoom: 12, bbox: [77.45, 12.85, 77.75, 13.10] },
];
