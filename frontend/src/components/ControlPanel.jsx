...
export default function ControlPanel({ onRun, onRegionSelect, onUploadGeoJSON }) {
  ...
  return (
    <aside className="flex w-80 shrink-0 flex-col gap-5 overflow-y-auto border-r border-slate-200 bg-white p-4">
      <section>
        <h2 className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">
          Area of interest
        </h2>
        <button className="mb-2 flex w-full items-center gap-2 rounded border border-slate-300 px-3 py-2 text-sm hover:bg-slate-50">
          <Square size={16} /> Draw bounding box
        </button>
